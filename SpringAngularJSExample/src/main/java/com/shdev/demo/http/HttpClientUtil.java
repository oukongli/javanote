...
public class HttpClientUtil {
    ...
    public static void main(String[] args) {
        // URL列表数组
        String[] urisToGet = {
                "http://localhost:8080/service/example/all"
//                "http://sports.sina.com.cn/nba/"
        ...
        try {
            ...
            CountDownLatch countDownLatch = new CountDownLatch(t * pageCount);
            for (int i = 0; i < pageCount * t; i++) {
                executors.execute(new GetRunnable(urisToGet[i % pageCount], countDownLatch));
            }
